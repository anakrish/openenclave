...
- `--recursive` option must be passed to git when cloning the Open Enclave repository.
...
- Removed dependency on nodejs and esy. Previously used to build Ocaml compiler and oeedger8r.
